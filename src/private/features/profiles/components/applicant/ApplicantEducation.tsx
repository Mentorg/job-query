...
function ApplicantEducation() {
  const { education, handleEducationUpdate, handleUpdate, handleDelete } =
    useEducation();
      ...
      <div className="flex items-center justify-between">
        ...
        <Modal>
          ...
          <Modal.Window name="add">
            <AddEducation
              education={education}
              onHandleEducationUpdate={handleEducationUpdate}
              onCloseModal={close}
            />
          </Modal.Window>
        </Modal>
        ...
        education.map((education) => (
          ...
          >
            ...
            <div className="col-start-1 col-end-3 row-start-4 self-baseline text-center sm:col-start-3 sm:row-start-2 lg:col-start-2 lg:place-self-center xl:col-start-5 xl:col-end-5 xl:row-start-1">
              ...
              <p className="font-medium">{education.honors}</p>
            </div>
